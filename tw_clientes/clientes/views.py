...
def inserir_cliente(request):
    ...
    if request.method == "POST":
        form_cliente = ClienteForm(request.POST)  #CADASTRANDO INFORMAÇÕES NO BD
        ...
        if form_cliente.is_valid():
            ...
            if form_endereco.is_valid(): #VALIDANDO FOMULARIO DE ENDEREÇO
                ...
                endereco_bd = endereco_service.cadastrar_endereco(endereco_novo) #CADASTRANDO NOVO ENDEREÇO
...
def editar_cliente(request, id):
    ...
    if form_cliente.is_valid():  #SALVAR AS INFORMÇÕES EDITADAS
        nome = form_cliente.cleaned_data["nome"]
        sexo = form_cliente.cleaned_data["sexo"]
        data_nascimento = form_cliente.cleaned_data["data_nascimento"]
        email = form_cliente.cleaned_data["email"]
